        ...
        <div className='mt-auto pt-2 flex flex-col gap-1.5'>
          <div className='grid grid-cols-2 gap-1.5'>
            ...
            <button
              ...
              disabled={claiming}
              className={`w-full py-2 text-white text-[10px] font-bold rounded-lg active:scale-95 transition-all font-dm-sans flex items-center justify-center gap-1 ${
                isFreeItem || added || isInCart(book.id || book._id || book.title, cartFormat)
          ...
          <div className='flex gap-6'>
            ...
            <aside
              className={`flex-shrink-0 sticky top-24 self-start transition-all duration-300 ${
                isFilterSidebarCollapsed ? '-mt-24 w-12' : 'w-49'
              }`}
            >
                  ...
                  <div className='flex flex-nowrap gap-1.5'>
                    {uniqueFormats.map(fmt => (
                      <button
                        ...
                        className={`px-2.5 py-1 rounded-full text-[11px] font-semibold border transition-all whitespace-nowrap shadow-sm ${
